...
export function BusIndicator(props) {
        ...
        <div className='flex items-center space-y-2 mb-6'>
            ...
            <div className="flex-1">
                ...
                <div className="flex items-center">
                    <div className="text-xs text-gray-400 font-light mr-3">{props.eta} mins away</div>
                    <div className="text-xs text-gray-400 font-light mr-3">{props.distance} meters away</div>
                </div>
            </div>
            <div onClick={() => {
                setStarred(!starred);
            }}>
                <FontAwesomeIcon icon={faStar} className={starred ? "text-yellow-500" : "text-gray-400"} />
            </div>
        </div>
    )
}